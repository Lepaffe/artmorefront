...
function Category(props) {
    ...
    return (
        ...
        <TouchableOpacity onPress={() => handleClickCategory(props.name)}>
            <Card
                wrapperStyle={{ border: 0, margin: 0, borderColor: "white" }}
                containerStyle={{ borderWidth: 0, borderColor: 'transparent', elevation: 0, shadowColor: 'rgba(0,0,0,0.2)', shadowOffset: { height: 0, width: 0 }, shadowOpacity: 0, shadowRadius: 0 }}>
